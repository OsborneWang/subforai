/**
 * Vue Router configuration for SubForAI frontend
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/help-docs',
    name: 'HelpDocs',
    component: () => import('@/views/HelpDocsView.vue'),
    meta: {
      requiresAuth: false,
      title: 'Help Docs'
    }
  ...
  {
    path: '/help-docs/:index',
    name: 'HelpDocDetail',
    component: () => import('@/views/HelpDocDetailView.vue'),
    meta: {
      requiresAuth: false,
      title: 'Help Doc'
    }
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'SubForAI'
