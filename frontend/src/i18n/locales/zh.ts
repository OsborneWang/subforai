export default {
  ...
  home: {
    ...
    helpDocs: {
      ...
      embedHint: '若文档站点禁止 iframe 嵌入，可使用新窗口打开。'
    },
    // CTA 区块
    cta: {
      title: '准备好开始了吗？',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 subforai-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 SubForAI 实例的场景。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 SubForAI 用户登录',
      ...
      site: {
        ...
        qqGroupNumber: '群号',
        qqGroupNumberPlaceholder: '例如：123456789',
        qqGroupLink: '加群链接',
        ...
        helpDocItem: '文档 #{n}',
        helpDocTitle: '文档标题',
        helpDocTitlePlaceholder: '例如：新用户快速开始',
        helpDocCategory: '分类',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每充值 1 CNY 可获得多少余额',
        balanceRechargePreview: '预览：充值 1 CNY，可获得 {usd} 余额',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 SubForAI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SubForAI 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 SubForAI',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 SubForAI AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：充值 1 CNY 获得 {usd} 余额',
    refundReason: '退款原因',
