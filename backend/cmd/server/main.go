...
import (
	...
	"github.com/OsborneWang/subforai/internal/setup"
	"github.com/OsborneWang/subforai/internal/web"
...
func main() {
	...
	if *showVersion {
		log.Printf("SubForAI %s (commit: %s, built: %s)\n", Version, Commit, Date)
		return
	}
...
func runSetupServer() {
	...
	log.Println("Complete the setup wizard to configure SubForAI")
