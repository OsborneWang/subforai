...
import "github.com/OsborneWang/subforai/internal/domain"
...
const (
	...
	SettingKeyCcsImportDefaultModelOpenAI = "ccs_import_default_model_openai" // 导入到 CCS 时 OpenAI/Codex 的默认模型
